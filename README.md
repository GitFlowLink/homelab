...
### Медиа
- **[Jellyfin](docker/mediaserver/)** — стриминг медиа по локалке без платных подписок
- **[qBittorrent](docker/qbittorrent/)** — торрент клиент с веб-интерфейсом
- **[Prowlarr](docker/mediaserver/)** — централизованный менеджер индексеров для медиастека
...
### Media
- **[Jellyfin](docker/mediaserver/)** — self-hosted media streaming instead of paid subscriptions
- **[qBittorrent](docker/qbittorrent/)** — torrent client with web UI
- **[Prowlarr](docker/mediaserver/)** — centralized indexer manager for the media stack
